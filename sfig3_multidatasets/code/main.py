...
def PlotCGDatasets(files,resultpath,figurepath):
    ...
    plt.savefig(figurepath+'/FigS3.png', dpi=600)
...
if __name__ == '__main__':
  ...
  networkpath = root_path + '/NetworkReduction/sfig3_multidatasets/network'  
  resultpath = root_path + '/NetworkReduction/sfig3_multidatasets/result'
  figurepath = root_path + '/NetworkReduction/sfig3_multidatasets/figure'
